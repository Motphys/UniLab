"""Final, fail-closed release evidence for managed MuJoCo/MJWarp rollout.
...
from tooling.acceptance.phase2 import (
...
from tooling.acceptance.phase4 import (
    load_phase4_evidence,
    validate_phase4_evidence,
)
from tooling.acceptance.phase5 import (
    load_phase5_evidence,
    validate_phase5_evidence,
)
from tooling.acceptance.phase6 import (
    load_phase6_evidence,
    validate_phase6_evidence,
)
from tooling.acceptance.support_audit import (
...
CHILD_ISSUE = 843
SCHEMA_VERSION = 1
ARTIFACT_KIND = "manager_mjwarp-final-gate-evidence-v1"
PLAN_FINGERPRINT = "manager_mjwarp-final-gate-v1"
INTEGRATION_BRANCH = "feat/manager-mjwarp-manager-mjwarp"

ACCEPTANCE_ROOT = Path("tests/acceptance/manager_mjwarp")
...
_EXPECTED_PHASE_VALIDATORS = {
    1: "manager_mjwarp_phase1_evidence",
    2: "manager_mjwarp_phase2_evidence",
    3: "manager_mjwarp_phase3_evidence",
    4: "manager_mjwarp_phase4_evidence",
    5: "manager_mjwarp_phase5_evidence",
    6: "manager_mjwarp_phase6_evidence",
}
...
class FinalGatePlanError(ValueError):
    ...
    def __init__(self, source: Path, errors: Sequence[str]) -> None:
        ...
        super().__init__(
            f"invalid managed MuJoCo/MJWarp rollout final gate plan {source}:\n{detail}"
        )
...
def _phase7_contract(
    ...
    *,
    ...
    if manifest.issue != ISSUE or manifest.phase != PHASE:
        errors.append(
            "Phase 7 manifest identity differs from managed MuJoCo/MJWarp rollout final gate"
        )
...
def capture_final_gate_evidence(root: Path, plan: FinalGatePlan) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "diagnostics": {
            ...
            "source_artifacts": [
                "tests/acceptance/manager_mjwarp/artifacts/phase_5_mjwarp_ppo.json",
