"""Fail-closed evidence contract for the managed MuJoCo/MJWarp rollout Phase 1 gate."""
...
ISSUE = 705
PHASE = 1
ARTIFACT_KIND = "manager_mjwarp-phase1-gate-v1"
MANIFEST_PATH = Path("tests/acceptance/manager_mjwarp/manifests/phase_1.yaml")
...
_STATIC_INPUTS = (
    ...
    Path("tooling/acceptance/phase1.py"),
    Path("scripts/audit_acceptance.py"),
    Path("scripts/capture_acceptance.py"),
    Path("tests/tools/test_manager_mjwarp_phase1_evidence.py"),
    Path("tests/tools/test_backend_isolation.py"),
    Path("tests/acceptance/manager_mjwarp/test_phase1_evidence.py"),
