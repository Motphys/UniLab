"""Fail-closed evidence contract for the managed MuJoCo/MJWarp rollout Phase 4 gate."""
...
ISSUE = 705
PHASE = 4
ARTIFACT_KIND = "manager_mjwarp-phase4-gate-v1"
MANIFEST_PATH = Path("tests/acceptance/manager_mjwarp/manifests/phase_4.yaml")
MUJOCO_OWNER = Path("conf/ppo/task/g1_walk_flat/mujoco.yaml")
HOST_BENCHMARK_ARTIFACT = Path(
    "tests/acceptance/manager_mjwarp/artifacts/phase_4_host_benchmark.json"
)
...
_STATIC_INPUTS = (
    Path("uv.lock"),
    MUJOCO_OWNER,
    Path("tests/acceptance/manager_mjwarp/g1_mujoco_baseline_plan.yaml"),
    Path("tests/acceptance/manager_mjwarp/g1_threshold_manifest.yaml"),
    Path("tests/acceptance/manager_mjwarp/g1_threshold_freeze_receipt.yaml"),
    HOST_BENCHMARK_ARTIFACT,
    Path("benchmark/env/benchmark_managed_g1.py"),
    Path("tooling/acceptance/phase_evidence.py"),
    Path("tooling/acceptance/phase4.py"),
    Path("scripts/capture_acceptance.py"),
    Path("tests/tools/test_manager_mjwarp_phase4_evidence.py"),
    Path("tests/acceptance/manager_mjwarp/test_phase4_evidence.py"),
