"""Frozen paired-seed training behavior evidence for managed MuJoCo/MJWarp rollout Phase 7."""
...
PLAN_PATH = Path("tests/acceptance/manager_mjwarp/training_behavior_plan.yaml")
FREEZE_RECEIPT_PATH = Path("tests/acceptance/manager_mjwarp/training_behavior_freeze_receipt.yaml")
ARTIFACT_PATH = Path("tests/acceptance/manager_mjwarp/artifacts/phase_7_training_behavior.json")

SCHEMA_VERSION = 1
ISSUE = 837
PARENT_ISSUE = 705
CLAIM_ID = "P7-TRAINING-BEHAVIOR"
BENCHMARK_ID = "manager_mjwarp-training-behavior-v1"
ARTIFACT_KIND = "manager_mjwarp-training-behavior-evidence-v1"
...
def _plan_schema_errors(raw: Mapping[str, Any]) -> list[str]:
    ...
    expected_paths = {
        ...
        "phase_manifest": "tests/acceptance/manager_mjwarp/manifests/phase_7.yaml",
        "baseline_plan": "tests/acceptance/manager_mjwarp/g1_mujoco_baseline_plan.yaml",
        "threshold_manifest": "tests/acceptance/manager_mjwarp/g1_threshold_manifest.yaml",
        "threshold_receipt": "tests/acceptance/manager_mjwarp/g1_threshold_freeze_receipt.yaml",
        "baseline_artifact": (
    ...
    for required in (
        ...
        "tooling/acceptance/training_behavior.py",
        "tests/benchmark/test_manager_mjwarp_training_behavior.py",
        "tests/tools/test_manager_mjwarp_training_behavior.py",
        "uv.lock",
    ):
