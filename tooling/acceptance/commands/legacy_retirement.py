...
"""Audit managed MuJoCo/MJWarp rollout mjwarp legacy-route retirement and rollback evidence."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        if args.json:
            ...
            print(f"FAIL managed MuJoCo/MJWarp rollout legacy retirement audit\n- {exc}")
        return 1
    ...
    if args.json:
        ...
        print(
            "PASS managed MuJoCo/MJWarp rollout legacy retirement audit "
        ...
        print("FAIL managed MuJoCo/MJWarp rollout legacy retirement audit")
