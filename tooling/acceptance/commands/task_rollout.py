...
"""Audit the managed MuJoCo/MJWarp rollout capability-derived mjwarp task rollout plan."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Rollout plan YAML (defaults to the managed MuJoCo/MJWarp rollout repository plan).",
    )
    ...
    try:
        ...
        if args.json:
            ...
            print(f"FAIL managed MuJoCo/MJWarp rollout task rollout audit\n- {exc}")
        return 1
    ...
    if args.json:
        ...
        print(
            "PASS managed MuJoCo/MJWarp rollout task rollout audit "
            f"entries={report.entries} prerequisites={report.prerequisites}"
        )
    else:
        print("FAIL managed MuJoCo/MJWarp rollout task rollout audit")
