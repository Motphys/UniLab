...
"""Audit managed MuJoCo/MJWarp rollout support claims against independent repository evidence."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Support evidence YAML (defaults to the managed MuJoCo/MJWarp rollout repository manifest).",
    )
    ...
    try:
        ...
        if args.json:
            ...
            print(f"FAIL managed MuJoCo/MJWarp rollout support audit\n- {exc}")
        return 1
    ...
    if args.json:
        ...
        print(
            "PASS managed MuJoCo/MJWarp rollout support audit "
        ...
        print("FAIL managed MuJoCo/MJWarp rollout support audit")
