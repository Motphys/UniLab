"""Validate the frozen managed MuJoCo/MJWarp rollout mjwarp field-level DR inventory.

uv run scripts/audit_acceptance.py dr-inventory
uv run scripts/audit_acceptance.py dr-inventory --json
"""
