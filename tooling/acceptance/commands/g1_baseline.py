"""Validate the frozen managed MuJoCo/MJWarp rollout G1 MuJoCo baseline artifact.

uv run scripts/audit_acceptance.py g1-baseline
uv run scripts/audit_acceptance.py g1-baseline --json
"""
...
PLAN_PATH = Path("tests/acceptance/manager_mjwarp/g1_mujoco_baseline_plan.yaml")
ARTIFACT_PATH = Path("tests/acceptance/manager_mjwarp/artifacts/g1_mujoco_phase0_baseline.json")
