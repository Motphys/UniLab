"""Fail-closed evidence contract for the managed MuJoCo/MJWarp rollout Phase 3 gate."""
...
PHASE = 3
SCHEMA_VERSION = 1
ARTIFACT_KIND = "manager_mjwarp-phase3-gate-v1"
MANIFEST_PATH = Path("tests/acceptance/manager_mjwarp/manifests/phase_3.yaml")
...
_STATIC_INPUTS = (
    ...
    Path("tooling/acceptance/phase3.py"),
    Path("scripts/capture_acceptance.py"),
    Path("tests/tools/test_manager_mjwarp_phase3_evidence.py"),
    Path("tests/acceptance/manager_mjwarp/test_phase3_evidence.py"),
