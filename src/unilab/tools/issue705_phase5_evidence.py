"""Fail-closed evidence contract for the Issue #705 Phase 5 gate.
...
ISSUE = 705
PHASE = 5
ARTIFACT_KIND = "issue705-phase5-gate-v1"
MANIFEST_PATH = Path("tests/acceptance/issue_705/manifests/phase_5.yaml")
MJWARP_OWNER = Path("conf/ppo/task/g1_walk_flat/mjwarp.yaml")
PPO_ARTIFACT = Path("tests/acceptance/issue_705/artifacts/phase_5_mjwarp_ppo.json")
PPO_TRACE = Path("tests/acceptance/issue_705/artifacts/issue705_phase5_ppo_5593eea8_trace.json")
...
_EVIDENCE_INPUTS = (
    ...
    Path("src/unilab/tools/issue705_phase5_evidence.py"),
    Path("scripts/capture_issue705_phase5_evidence.py"),
    Path("tests/tools/test_issue705_phase5_evidence.py"),
    Path("tests/acceptance/issue_705/test_phase5_evidence.py"),
)
