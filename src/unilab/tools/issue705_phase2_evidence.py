"""Fail-closed evidence contract for the Issue #705 Phase 2 gate."""
...
MANIFEST_PATH = Path("tests/acceptance/issue_705/manifests/phase_2.yaml")
...
_STATIC_INPUTS = (
    ...
    Path("src/unilab/tools/issue705_phase2_evidence.py"),
    Path("scripts/capture_issue705_phase2_evidence.py"),
    Path("tests/tools/test_issue705_phase2_evidence.py"),
    Path("tests/acceptance/issue_705/test_phase2_evidence.py"),
