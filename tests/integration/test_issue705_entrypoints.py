"""Production entrypoint matrix for the promoted Issue #705 owner."""
...
_NUM_ENVS = 128
_STEPS_PER_ENV = 2
_ENTRYPOINT_FINGERPRINT = "issue705-entrypoints-v1"
...
def _require_cuda_mjwarp() -> None:
    ...
    if not is_cuda:
        pytest.fail("Issue #705 entrypoint matrix requires an active CUDA Warp device")
