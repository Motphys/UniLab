...
from scripts import validate_issue705_dr_inventory


def test_repository_mjwarp_dr_inventory_cli_passes(capsys) -> None:
    exit_code = validate_issue705_dr_inventory.main([])
...
def test_repository_mjwarp_dr_inventory_cli_emits_json(capsys) -> None:
    exit_code = validate_issue705_dr_inventory.main(["--json"])
...
def test_cli_fails_closed_on_malformed_inventory(tmp_path: Path, capsys) -> None:
    ...
    exit_code = validate_issue705_dr_inventory.main(["--inventory", str(inventory)])
...
def test_cli_fails_closed_on_malformed_claim_inventory(tmp_path: Path, capsys) -> None:
    ...
    exit_code = validate_issue705_dr_inventory.main(["--claim-inventory", str(inventory)])
