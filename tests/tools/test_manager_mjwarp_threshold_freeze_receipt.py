...
from tooling.acceptance import thresholds as manager_mjwarp_thresholds
...
MANIFEST_PATH = REPO_ROOT / "tests/acceptance/manager_mjwarp/g1_threshold_manifest.yaml"
RECEIPT_PATH = REPO_ROOT / "tests/acceptance/manager_mjwarp/g1_threshold_freeze_receipt.yaml"
...
def test_shallow_checkout_uses_hash_receipt_without_false_ancestry_failure(
    ...
    monkeypatch.setattr(manager_mjwarp_thresholds, "_git", fake_git)
