...
BASE_MANIFEST_PATH = REPO_ROOT / "tests/acceptance/manager_mjwarp/g1_threshold_manifest.yaml"
AMENDMENT_PATH = REPO_ROOT / AMENDMENT_MANIFEST_PATH
BASE_RECEIPT_PATH = REPO_ROOT / "tests/acceptance/manager_mjwarp/g1_threshold_freeze_receipt.yaml"
...
def test_amendment_is_narrow_and_preserves_base(base_manifest, base_receipt) -> None:
    ...
    assert amendment.data["scope"]["artifact_kind"] == (
        "manager_mjwarp-mjwarp-device-ppo-benchmark-v1"
    )
