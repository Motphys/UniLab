...
import pytest
from benchmark.env import benchmark_g1_baseline
...
from benchmark.mjwarp import process_dr_evidence
...
@pytest.mark.parametrize(
    ("module", "preflight"),
    [
        (benchmark_g1_baseline, benchmark_g1_baseline._preflight_payload),
        (process_dr_evidence, process_dr_evidence.preflight_payload),
    ],
)
