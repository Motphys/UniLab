...
| PPO (torch) | `microduck_velocity_flat` (microduck velocity flat) | Tested | Registered | - | - |
| PPO (torch) | `microduck_walk_straight` (microduck walk straight) | Tested | Registered | - | - |
