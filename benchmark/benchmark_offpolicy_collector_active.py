...
NP_ENV_STEP_TIMING_CSV_FIELDS = (
    ...
    ("dr_reset_set_state_alloc_state_ms", "dr_reset_set_state_alloc_state_ms"),
    ("dr_reset_set_state_fill_qpos_ms", "dr_reset_set_state_fill_qpos_ms"),
    ("dr_reset_set_state_fill_qvel_ms", "dr_reset_set_state_fill_qvel_ms"),
    ("dr_reset_set_state_env_ids_ms", "dr_reset_set_state_env_ids_ms"),
    ...
    ("dr_reset_set_state_data_reset_ms", "dr_reset_set_state_data_reset_ms"),
    ("dr_reset_set_state_clear_forces_ms", "dr_reset_set_state_clear_forces_ms"),
    ("dr_reset_set_state_geom_overrides_ms", "dr_reset_set_state_geom_overrides_ms"),
    ("dr_reset_set_state_randomization_ms", "dr_reset_set_state_randomization_ms"),
    ("dr_reset_set_state_set_dof_vel_ms", "dr_reset_set_state_set_dof_vel_ms"),
    ("dr_reset_set_state_set_dof_pos_ms", "dr_reset_set_state_set_dof_pos_ms"),
    ...
    ("dr_reset_set_state_pool_reset_ms", "dr_reset_set_state_pool_reset_ms"),
    (
        "dr_reset_set_state_physics_state_scatter_ms",
        "dr_reset_set_state_physics_state_scatter_ms",
    ),
