...
aligned with benchmark/physics/benchmark_physics_step_mj_step.py.
Legacy env names remain accepted as aliases.

Run without changing repo dependencies:
    uv run --with genesis-world \
        python benchmark/physics/benchmark_physics_step_genesis.py
"""
...
def _uv_run_hint() -> str:
    return "uv run --with genesis-world python benchmark/physics/benchmark_physics_step_genesis.py"
