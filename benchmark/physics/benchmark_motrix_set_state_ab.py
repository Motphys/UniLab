...
Usage::
    ...
    uv run python benchmark/physics/benchmark_motrix_set_state_ab.py \
        --num-envs 1024 --iters 30 --warmup 5
    uv run python benchmark/physics/benchmark_motrix_set_state_ab.py --out benchmark/outputs/set_state_ab.json
"""
