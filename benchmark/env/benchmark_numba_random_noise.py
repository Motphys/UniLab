...
Run:
    uv run python -m benchmark.env.benchmark_numba_random_noise
    uv run python benchmark/env/benchmark_numba_random_noise.py --quick
    uv run python -m benchmark.env.benchmark_numba_random_noise --profiles sac_g1_motion_tracking_mujoco --threads 1 4 8
"""
