...
Run:
    uv run python -m benchmark.env.benchmark_g1_motion_tracking_numba
    uv run python benchmark/env/benchmark_g1_motion_tracking_numba.py
    uv run python -m benchmark.env.benchmark_g1_motion_tracking_numba --quick
    uv run python -m benchmark.env.benchmark_g1_motion_tracking_numba --no-e2e
"""
...
def _run_e2e_collector_pair(
    *,
    ...
    from benchmark.rl.benchmark_offpolicy_collector_active import _build_and_run_case
