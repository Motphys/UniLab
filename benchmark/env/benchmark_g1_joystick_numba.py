...
Run:
    uv run python -m benchmark.env.benchmark_g1_joystick_numba
    uv run python benchmark/env/benchmark_g1_joystick_numba.py
    uv run python -m benchmark.env.benchmark_g1_joystick_numba --quick
    uv run python -m benchmark.env.benchmark_g1_joystick_numba --quick --e2e
"""
