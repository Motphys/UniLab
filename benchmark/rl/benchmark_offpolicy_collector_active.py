...
Usage:
    ...
    uv run benchmark/rl/benchmark_offpolicy_collector_active.py --backend motrix
    uv run benchmark/rl/benchmark_offpolicy_collector_active.py --all
    uv run benchmark/rl/benchmark_offpolicy_collector_active.py --cases auto --backend mujoco
    uv run benchmark/rl/benchmark_offpolicy_collector_active.py --cases auto --backend motrix
    uv run benchmark/rl/benchmark_offpolicy_collector_active.py --cases sac/g1_walk_flat/mujoco
    uv run benchmark/rl/benchmark_offpolicy_collector_active.py --cases sac/g1_walk_flat/motrixsim
    uv run benchmark/rl/benchmark_offpolicy_collector_active.py --num-envs 1024 --measure-steps 100
"""
