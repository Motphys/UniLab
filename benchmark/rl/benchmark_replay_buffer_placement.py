...
Usage:
    ...
    uv run benchmark/rl/benchmark_replay_buffer_placement.py --tasks auto
    uv run benchmark/rl/benchmark_replay_buffer_placement.py --warmup 3 --repeat 10
    uv run benchmark/rl/benchmark_replay_buffer_placement.py --max-capacity-rows 1048576
"""
